...
<출력>
점수를 내기 위한 이유를 차근차근 생각하세요. 마지막에 "점수: [1부터 5사이의 점수, 소수점 단위 0.5]" 형태로 평가 점수를 출력하세요.
"""
...
model.load_state_dict(torch.load('1112_long_complex_newprompt_8bits.pth'))
...
# %%
test_df.to_csv('1112_long_complex_newprompt_8bits.csv', index=False)
